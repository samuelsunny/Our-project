                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php for ($row = 0; $row < count($products_data); $row++) { ?>
                            <form method = "get">   
                                <li>
                                    <a class="dropdown-item" href="http://localhost/Container-Scheduling-and-management/test.php?product_name=<?php echo $products_data[$row][1]; ?>"id="product" name="product_id" value="<?php $products_data[$row][0]; ?>">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php for ($row = 0; $row < count($products_data); $row++) { ?>
                            <form method = "get">   
                                <li>
                                    <a class="dropdown-item" href="http://localhost/Container-Scheduling-and-management/test.php?product_name=<?php echo $products_data[$row][1]; ?>" id="warehouse" name="product_id" value="<?php $products_data[$row][0]; ?>">
                                        <?php echo $products_data[$row][2]," ",$products_data[$row][1]; ?>
                                    </a>
                                </li>
                            </form>
